  ...
  return (
    <div className="flex flex-col items-center justify-center mx-auto">
      ...
      <div className="flex gap-6 mx-auto mt-10">
        <Card className="flex size-16px w-80 h-auto bg-gradient-to-b from-purple-200 to-purple-90 border-blue-800">
          <div className="flex justify-center ">
            <Image
              ...
              width={300}
              height={200}
              className="rounded-lg border-10 border-purple-200"
            />
          </div>
          <CardHeader>
        ...
        <Card className="flex size-16px w-80 h-auto bg-gradient-to-t from-orange-200 to-orange-90 border-blue-800">
          <div className="flex justify-center ">
            <Image
              src="/unified.png"
              alt="Booking"
              width={300}
              height={400}
              className="rounded-lg border-10 border-orange-180"
            />
          </div>
          <CardHeader>
            <CardTitle className="font-bold text-xl pt-3">
        ...
        <Card className="flex size-16px w-80 h-auto bg-gradient-to-b from-blue-200 to-blue-90 border-blue-800">
          <div className="flex justify-center ">
            <Image
              src="/proactive.png"
              alt="Booking"
              width={300}
              height={400}
              className="rounded-lg border-10 border-blue-200"
            />
          </div>
          <CardHeader>
            <CardTitle className="font-bold text-xl pt-3">
              Proactive Workflow <br /> Assistant
            </CardTitle>
            <CardDescription className=" text-left">
