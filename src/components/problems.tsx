...
const Problems = () => {
  return (
    <div className="flex flex-col items-center justify-center mx-auto px-4 md:px-14 lg:px-16 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10 w-full max-w-6xl">
        <Card className="flex flex-col w-full max-w-sm mx-auto h-auto bg-blue-100 text-blue-100">
        ...
        <Card className="flex flex-col w-full max-w-sm mx-auto h-auto   bg-gradient-to-b from-blue-200 to-blue-500 border-blue-800 text-white">
